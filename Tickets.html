   ...
   <br>
    ...
    <body>     
        ...
        <p id="text">There are two ways to buy tickets for Premier League home games at Old Trafford. 
           ...
           <a href="buyticket.html"> <button id="button1" type="button" >BUY TICKETS <small>&#8594 </small></button></a>
            
           <a href="buyticket.html"><button  id="butoni1" type="button" > BUY MATCHDAY VIP<small>&#8594 </small></button></a>
